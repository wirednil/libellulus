...
#define VERBUM_INIT(LEVEL) wrapper_init(LEVEL)

/**
 * @brief Logs a message at the DEBUG level using a wrapper around WLogger.
 *
 * The VERBUM_DEBUG macro logs a message at the DEBUG level using a wrapper around WLogger. It accepts a printf-style
 ...
 *
 * The VERBUM_INFO macro logs a message at the INFO level using a wrapper around WLogger. It accepts a printf-style
 * format string and zero or more additional arguments to be formatted and included in the log message. The macro
 * automatically includes information about the file, line number, and function where it was called.
 *
 * @param FMT The printf-style format string for the log message.
 ...
 *
 * The VERBUM_ERROR macro logs a message at the ERROR level using a wrapper around WLogger. It accepts a printf-style
 * format string and zero or more additional arguments to be formatted and included in the log message. The macro
 * automatically includes information about the file, line number, and function where it was called.
 *
 * @param FMT The printf-style format string for the log message.
 ...
 *
 * The VERBUM_WARNING macro logs a message at the WARNING level using a wrapper around WLogger. It accepts a printf-style
 * format string and zero or more additional arguments to be formatted and included in the log message. The macro
 * automatically includes information about the file, line number, and function where it was called.
 *
 * @param FMT The printf-style format string for the log message.
 ...
 *
 * The VERBUM_FATAL macro logs a message at the FATAL level using a wrapper around WLogger. It accepts a printf-style
 * format string and zero or more additional arguments to be formatted and included in the log message. The macro
 * automatically includes information about the file, line number, and function where it was called.
 *
 * @param FMT The printf-style format string for the log message.
